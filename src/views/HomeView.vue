      ...
      <v-row>
        <v-col cols="12">
          <v-card class="mx-auto rounded-xl" flat>
            <v-img src="cover2.png" max-height="100%" max-width="100%" contain>
              <!-- <v-card-title class="top ml-10">
                <h2 class="title1">What do you need?</h2>
              </v-card-title> -->
              <!-- <v-card-title class="top ml-10">
                <h2 class="title2">무엇이 필요하신가요?</h2>
              </v-card-title> -->
              <!-- <v-card-text class="ml-10">
                <h3 class="green--text">무료 배달</h3>
              </v-card-text> -->
              <v-card-text class="ml-10">
                <v-row>
                  <v-col cols="4">
          ...
          <v-toolbar flat color="transparent">
            <v-toolbar-title class="text-h6">Category&nbsp<small>품목</small></v-toolbar-title>
            <v-spacer></v-spacer>
          ...
          <v-toolbar flat color="transparent" class="mt-5">
            <v-toolbar-title class="text-h6">Popular Product <small>인기 상품</small></v-toolbar-title>
            <v-spacer></v-spacer>
          ...
          <v-card flat color="#E2F2E5" class="rounded-xl mt-8">
            <v-toolbar flat color="transparent" class="mb-4">
              <v-toolbar-title class="text-h6 mt-5"
                >New Arrivals <small>신규 상품</small></v-toolbar-title
              >
              <v-spacer></v-spacer>
            </v-toolbar>
          ...
          <v-card flat color="#FAFAFA" class="mt-8 py-5 px-16">
            <div
              ...
              "
            >
              <h3>Customer Feedback <small>고객 리뷰</small></h3>
            </div>
            <Client />
          </v-card>
          <v-toolbar flat color="transparent" class="mt-8">
            <v-toolbar-title class="text-h6"
              >Our Trusted Partner <small>협력 업체</small></v-toolbar-title
            >
          </v-toolbar>
          <Partner />
          <v-card
          ...
          >
            <v-row>
              ...
              <v-col cols="12" xs="12" sm="6" md="7">
                <h1 class="mt-16">Download App <small>앱 내려받기</small></h1>
                <p>
                  자사 앱을 통하여 다양한 기능과 서비스를 제공합니다.<br>
                  간단한 앱 설치로 더 많은 혜택을 받아보세요.
                </p>
